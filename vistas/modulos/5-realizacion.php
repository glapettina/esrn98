        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button type="submit" class="btn btn-danger" idCurso1=10 idCurso2=11 tabla="quinto" data-toggle="modal" data-target="#modalCopiaSaberes">
                  
                  Copia Saberes
                </button>

                <button class="btn btn-primary btnInformeArea" area="realizacion" idCurso=10 idCurso2=11 tabla="quinto" informe="informe-area-orientacion">
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarInformeRealizacion" tabla="quinto" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarInforme"><i class="fa fa-pencil"></i></button>
                            ...
                            echo '<div class="btn-group">
                              ...
                              <button class="btn btn-primary btnImprimirInformeIndividual" informe="informe-individual" tabla="quinto" area="realizacion" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeIndividual"><i class="fa fa-print"></i></button>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
         ...
         <?php
              ...
              $copiaSaberes -> ctrCopiarSaberesRealizacion($tabla, $curso, $ncurso1, $ncurso2);
