        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">
                ...
                <button type="submit" class="btn btn-danger" idCurso=5 tabla="tercero" data-toggle="modal" data-target="#modalCopiaSaberes">
                  
                  Copia Saberes
                </button>

                <button class="btn btn-primary btnInformeArea" area="cientifica" idCurso=5 tabla="tercero" informe="informe-area">
          ...
          <table class="table table-bordered table-striped dt-responsive tablas">
            ...
            <tbody>
              ...
              <?php
                  ...
                  $informes = ControladorInformes::ctrMostrarInformes($item, $valor, $tabla, $verifica);
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              <button class="btn btn-warning btnEditarInformeCientifica" tabla="tercero" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarInforme"><i class="fa fa-pencil"></i></button>
                            ...
                            echo '<div class="btn-group">
                              ...
                              <button class="btn btn-primary btnImprimirInformeIndividual" informe="informe-individual" tabla="tercero" area="cientifica" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeIndividual"><i class="fa fa-print"></i></button>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
         ...
         <?php
              ...
              $copiaSaberes -> ctrCopiarSaberesCientifica($tabla, $curso, $ncurso);
